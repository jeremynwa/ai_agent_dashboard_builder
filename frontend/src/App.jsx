...
const translations = {
  en: {
    ...
    automationRefine: 'Refine',
    automationRefinePlaceholder: 'Describe changes to your workflow...',
    automationExamples: 'Try an example',
    automationTemplates: 'My Templates',
    automationTemplateUse: 'Use',
    automationNoTemplates: 'No saved templates yet.',
  ...
  fr: {
    ...
    automationExecute: 'Exécuter',
    automationRefine: 'Affiner',
    automationRefinePlaceholder: 'Décrivez les modifications souhaitées...',
    automationExamples: 'Essayez un exemple',
    automationTemplates: 'Mes templates',
    automationTemplateUse: 'Utiliser',
    automationNoTemplates: 'Aucun template sauvegardé.',
    automationIntegrations: 'Intégrations',
    'rr.title': 'Review Research',
          ...
          <div style={styles.landingContainer}>
            ...
            <div style={{ ...styles.landingCards, flexWrap: 'wrap', justifyContent: 'center' }}>
              ...
              >
                ...
                <h2 style={styles.landingCardTitle}>{t('landingSubmit')}</h2>
              ...
              >
                ...
                <h2 style={{ ...styles.landingCardTitle, color: SK.aqua }}>{t('landingBuild')}</h2>
